...
class UserRegistrationServiceImplTest {
    ...
    void testGetAllUsersInAGroup_Success(){
        ...
        when(TaskTrackerInterceptor.getLoggedInUserName()).thenReturn("admin");
        when(TaskTrackerInterceptor.getLoggedInUserRole()).thenReturn(AuthConstant.REGISTRATION_ROLE_ADMIN);
        ...
        when(userInfoRepository.findAllByGroupIdAndDeleteFlag(1, AuthConstant.DELETE_FLAG_FALSE)  ).thenReturn(userInfoList);
    ...
    public void testUpdateUserInfo_Admin_Success() {
        ...
        requestDTO.setPasswordChangeMandatory(AuthConstant.TASK_PWD_CHANGE_MANDATORY_TRUE);
        requestDTO.setDeleteFlag(AuthConstant.DELETE_FLAG_TRUE);
        ...
        assertEquals(AuthConstant.DELETE_FLAG_TRUE, output.getDeleteFlag());
